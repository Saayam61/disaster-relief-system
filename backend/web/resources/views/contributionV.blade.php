                            ...
                            <tbody>
                                @foreach($contributions as $contribution)
                                    <tr>
                                        ...
                                        <td>
                                        @php
                                            $vol = Auth::user()->volunteer ?? null;
                                        @endphp
                                            @if(Auth::user()->role === 'Volunteer' && $vol->volunteer_id === $contribution->volunteer_id)
                                            <div class="btn-group d-flex justify-content-start">
                                                <form action="{{ route('contributionv.destroy', $contribution->contribution_id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
